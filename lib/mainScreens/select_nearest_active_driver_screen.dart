...
class _SelectNearestActiveDriversScreenState extends State<SelectNearestActiveDriversScreen>
{
  ...
  getFareAmountAccordingToVehicleType(int index)
  {
    ...
    {
      if(dList[index]["car_details"]["type"].toString() == "bicicleta")
      {
        fareAmount = (AssistantMethods.calculateFareAmountFromOriginToDestination(tripDirectionDetailsInfo!) / 2).toStringAsFixed(1);
      }
      if(dList[index]["car_details"]["type"].toString() == "camion") //means executive type of car - more comfortable pro level
          {
        fareAmount = (AssistantMethods.calculateFareAmountFromOriginToDestination(tripDirectionDetailsInfo!) * 2).toStringAsFixed(1);
      }
      if(dList[index]["car_details"]["type"].toString() == "auto") // non - executive car - comfortable
          {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: ()
          {
            ...
            Fluttertoast.showToast(msg: "Has finalizado el pedido.");
