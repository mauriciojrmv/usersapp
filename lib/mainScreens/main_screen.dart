...
class _MainScreenState extends State<MainScreen>
{
  ...
  String driverRideStatus = "Conductor ya viene";
  ...
  async {
    ...
    //aqui guardaremos el ride request information
  referenceRideRequest = FirebaseDatabase.instance.ref().child("All Ride Requests").push(); //aqui generaremos ids unicas a cada request
  ...
  updateArrivalTimeToUserPickupLocation(driverCurrentPositionLatLng) async
  {
    if(requestPositionInfo == true)
    {
      ...
      setState(() {
        driverRideStatus =  "El conductor llegara :: " + directionDetailsInfo.duration_text.toString();
      });
  ...
  updateReachingTimeToUserDropOffLocation(driverCurrentPositionLatLng) async
  {
    if(requestPositionInfo == true)
    {
      ...
      setState(() {
        driverRideStatus =  "Yendo a destino :: " + directionDetailsInfo.duration_text.toString();
      });
  ...
  searchNearestOnlineDrivers() async
  {
    ...
    if(onlineNearByAvailableDriversList.length == 0)
    {
      ...
      Fluttertoast.showToast(msg: "No hay conductores, se reiniciara la app");
          ...
          .then((snap)
      {
        if(snap.snapshot.value != null)
        {
              ...
              .onValue.listen((eventSnapshot)
          {
            ...
            {
              Fluttertoast.showToast(msg: "El conductor cancelo. Por favor escoja otro");

              Future.delayed(const Duration(milliseconds: 3000), ()
              {
                Fluttertoast.showToast(msg: "Reinicia la App ahora.");
        ...
        {
          Fluttertoast.showToast(msg: "El conductor no esta pruebe otro.");
        }
      });
    }
  }
  ...
  sendNotificationToDriverNow(String chosenDriverId)
  {
        ...
        .child("token").once().then((snap)
    {
      if(snap.snapshot.value != null)
      {
        ...
        Fluttertoast.showToast(msg: "Notificacion enviada.");
      }
      else
      {
        Fluttertoast.showToast(msg: "Escoga otro conductor.");
        return;
      }
    });
  }
            ...
            child: GestureDetector(
              onTap: ()
              {
                if (openNavigationDrawer)
                  ...
                  {
                    //restart - refresh - minimize app automatically, in order to refresh
                    SystemNavigator.pop();
                  }
                sKey.currentState!.openDrawer();
              },
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: ()
                              {
                                if(Provider.of<AppInfo>(context, listen: false).userDropOffLocation != null)
                                  ...
                                  {
                                    Fluttertoast.showToast(msg: "Por favor seleccione destino");
                                  }
                              },
                              style: ElevatedButton.styleFrom(
